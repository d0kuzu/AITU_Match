...
from src.keyboards.inline import profile_action_keyboard, watch_likes_keyboard
...
async def handle_profile_action(callback_query: CallbackQuery, state: FSMContext, bot: Bot):
    ...
    if action == "like":
        ...
        await callback_query.bot.send_message(viewed_tg_id, "Тебя лайкнули, хочешь узнать кто это?",
